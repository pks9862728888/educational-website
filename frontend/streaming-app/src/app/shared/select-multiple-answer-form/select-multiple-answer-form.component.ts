...
@Component({
  selector: 'app-select-multiple-answer-form',
  templateUrl: './select-multiple-answer-form.component.html',
  styleUrls: ['./select-multiple-answer-form.component.css']
})
export class SelectMultipleAnswerFormComponent implements OnInit {
  ...
  submit() {
    ...
    this.instituteApiService.addUpdateSelectMultipleOption(
