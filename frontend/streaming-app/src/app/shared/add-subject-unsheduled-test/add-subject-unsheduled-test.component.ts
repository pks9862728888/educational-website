...
@Component({
  selector: 'app-add-subject-unsheduled-test',
  templateUrl: './add-subject-unsheduled-test.component.html',
  styleUrls: ['./add-subject-unsheduled-test.component.css']
})
export class AddSubjectUnsheduledTestComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.addTestForm = this.formBuilder.group({
      test_schedule_type: [TEST_SCHEDULE_TYPES.UNSCHEDULED, [Validators.required]],
  ...
  initializeForm() {
    ...
    this.addTestForm.patchValue({
      test_schedule_type: TEST_SCHEDULE_TYPES.UNSCHEDULED,
