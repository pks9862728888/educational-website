...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30, validators=[django.core.validators.MinLengthValidator(4), django.core.validators.ProhibitNullCharactersValidator], verbose_name='Institute Name')),
                ...
                ('institute_category', models.CharField(blank=True, choices=[('E', 'EDUCATION'), ('A', 'ART'), ('M', 'MUSIC'), ('D', 'DANCE')], max_length=1, verbose_name='Institute Category')),
                ('institute_slug', models.SlugField(blank=True, max_length=40, null=True, verbose_name='Institute Slug')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_no', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region=None, verbose_name='Phone')),
                ...
                ('logo', models.ImageField(blank=True, max_length=1024, null=True, upload_to=core.models.institute_logo_upload_file_path, validators=[django.core.validators.validate_image_file_extension], verbose_name='Logo')),
                ('banner', models.ImageField(blank=True, max_length=1024, null=True, upload_to=core.models.institute_banner_upload_file_path, validators=[django.core.validators.validate_image_file_extension], verbose_name='Banner')),
