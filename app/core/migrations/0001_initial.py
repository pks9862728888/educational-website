    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('O', 'OPTIONAL'), ('M', 'MANDATORY')], max_length=1, verbose_name='Subject Type')),
                ('institute_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='institute_class', to='core.InstituteClass')),
            ],
            options={
