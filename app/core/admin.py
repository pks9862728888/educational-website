...
# For subject test
admin.site.register(models.SubjectTest)
admin.site.register(models.SubjectTestSets)
admin.site.register(models.SubjectTestConceptLabels)
admin.site.register(models.SubjectFileTestQuestion)
admin.site.register(models.SubjectTestQuestionSection)
admin.site.register(models.SubjectPictureTestQuestion)
admin.site.register(models.SubjectTypedTestQuestion)
admin.site.register(models.SubjectTestQuestionImage)
admin.site.register(models.SubjectTestMcqOptions)
admin.site.register(models.SubjectTestTrueFalseCorrectAnswer)
admin.site.register(models.SubjectTestSelectMultipleCorrectAnswer)
admin.site.register(models.SubjectTestNumericCorrectAnswer)
admin.site.register(models.SubjectTestAssertionCorrectAnswer)
admin.site.register(models.SubjectTestFillInTheBlankCorrectAnswer)
admin.site.register(models.StudentTestCredential)
admin.site.register(models.StudentTestLoginStats)
