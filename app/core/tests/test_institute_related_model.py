...
#         self.assertEqual(res.storage, 1)
#
#
...
#         )
#         self.assertEqual(res.subject_class.class_institute, institute)
...
#             section_class=class_,
#             name=self.payload['name'])
#         self.assertEqual(res.section_class.class_institute, institute)
...
#                 key='MI'
#         ).first()
#         subject_content = create_institute_subject_content(
#             subject,
#             1,
#             view
#         )
