...
urlpatterns = [
    ...
    path('<slug:institute_slug>/<slug:subject_slug>/<slug:test_slug>/get-test-full-details',
         views.InstituteTestFullDetailsView.as_view(),
         name='get-test-full-details'),
    ...
    path('<slug:institute_slug>/<slug:subject_slug>/<slug:test_slug>/<int:set_id>/<int:question_id>/edit-typed'
         '-test-question',
         views.InstituteEditTypedTestQuestionView.as_view(),
         name='edit-typed-test-question'),
    path('<slug:institute_slug>/<slug:subject_slug>/<int:question_id>/delete-typed-test-question',
         views.InstituteDeleteTypedQuestionView.as_view(),
         name='delete-typed-test-question'),
    ...
    path('<slug:subject_slug>/<int:question_id>/<int:option_id>/delete-multiple-choice-option',
         views.InstituteTestDeleteMultipleChoiceOption.as_view(),
         name='delete-multiple-choice-option'),
    ...
    path('<slug:subject_slug>/<int:question_id>/add-update-fill-in-the-blank-checking',
         views.InstituteTestAddUpdateFillInTheBlankChecking.as_view(),
         name='add-update-fill-in-the-blank-checking'),
