...
urlpatterns = [
    ...
    path('<slug:institute_slug>/get-unpaid-common-license',
         views.InstituteUnpaidCommonLicenseDetailView.as_view(),
         name="get-unpaid-common-license"),
    ...
    path('<institute:institute_slug>/delete-common-license/<id:selected_license_id>',
         views.InstituteDeleteSelectedCommonLicenseView.as_view(),
         name='delete-common-license'),
    path('create-order',
