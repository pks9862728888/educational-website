...
#         self.assertEqual(res.data[0]['type'], payload['type'])
...
#                          payload['institute_category'])
#         self.assertEqual(institute.type, payload['type'])
...
#         self.assertEqual(res.data['type'],
#                          models.InstituteType.COLLEGE)
...
#                         models.InstituteRole.FACULTY))
#
#     def test_invitee_can_not_accept_admin_request_twice(self):
...
#                         models.InstituteRole.STAFF))
#
#     def test_invitee_can_not_accept_faculty_request_twice(self):
...
#         self.assertEqual(res.data['pending_admin_invites'][0]['invitee_id'], inactive_admin.pk)
...
#         self.assertEqual(res.data['active_admin_list'][0]['invitee_id'], self.user.pk)
...
#         self.assertEqual(res.data['pending_staff_invites'][0]['invitee_id'], inactive_staff.pk)
...
#         self.assertEqual(res.data['pending_faculty_invites'][0]['invitee_id'], inactive_faculty.pk)
